...
class CategoriesAdapter(private val categories: List<String>, private val categoriesClickListener:(String) -> Unit): RecyclerView.Adapter<CategoriesAdapter.CategoryHolder>() {
